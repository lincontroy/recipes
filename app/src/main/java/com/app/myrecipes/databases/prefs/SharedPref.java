package com.app.myrecipes.databases.prefs;
...
public class SharedPref {
    ...
    public String getApiUrl() {
        return sharedPreferences.getString("api_url", "https://recipe.ticketcraft.co.ke/api/api.php");
    }

    public String getApplicationId() {
        return sharedPreferences.getString("application_id", "com.app.myrecipes");
    }
