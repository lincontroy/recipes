...
import com.app.myrecipes.models.Ads;
...
public class ActivitySplash extends AppCompatActivity {
    ...
    private void loadConfig() {
        ...
        String apiUrl = "https://recipe.ticketcraft.co.ke/api/api.php";


        String applicationId = results[1];

//        Toast.makeText(getApplicationContext(),sharedPref.getApiUrl(),Toast.LENGTH_LONG).show();
